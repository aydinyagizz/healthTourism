...
var KTDiseasesList = function () {
    // Define shared variables
    var table = document.getElementById('kt_table_diseases');
    var datatable;
    var toolbarBase;
    var toolbarSelected;
    var selectedCount;
    ...
    var handleSearchDatatable = () => {
        const filterSearch = document.querySelector('[data-kt-diseases-table-filter="search"]');
    ...
    var handleResetForm = () => {
        // Select reset button
        const resetButton = document.querySelector('[data-kt-diseases-table-filter="reset"]');

        // Reset datatable
        resetButton.addEventListener('click', function () {
            // Select filter options
            const filterForm = document.querySelector('[data-kt-diseases-table-filter="form"]');
            const selectOptions = filterForm.querySelectorAll('select');
    ...
    $(document).ready(function() {
        var handleDeleteRowss = () => {
            ...
            const deleteButtons = table.querySelectorAll('[data-kt-diseases-table-filter="delete_row"]');
    ...
    var handleDeleteRows = () => {
        ...
        deleteButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                const diseasesId = parent.querySelectorAll('td')[1].querySelectorAll('a')[0].getAttribute('data-id');
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        Swal.fire({
                            ...
                            var deleteUrl = document.getElementById('delete-url-diseases').value;
    ...
    var initToggleToolbar = () => {
        ...
        // Select elements
        toolbarBase = document.querySelector('[data-kt-diseases-table-toolbar="base"]');
        toolbarSelected = document.querySelector('[data-kt-diseases-table-toolbar="selected"]');
        selectedCount = document.querySelector('[data-kt-diseases-table-select="selected_count"]');
        const deleteSelected = document.querySelector('[data-kt-diseases-table-select="delete_selected"]');
