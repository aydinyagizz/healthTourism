...
var KTBlogList = function () {
    // Define shared variables
    var table = document.getElementById('kt_table_blog');
    var datatable;
    var toolbarBase;
    var toolbarSelected;
    var selectedCount;
    ...
    var handleResetForm = () => {
        // Select reset button
        const resetButton = document.querySelector('[data-kt-blog-table-filter="reset"]');

        // Reset datatable
        resetButton.addEventListener('click', function () {
            // Select filter options
            const filterForm = document.querySelector('[data-kt-blog-table-filter="form"]');
            const selectOptions = filterForm.querySelectorAll('select');
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        Swal.fire({
                            ...
                            var deleteUrl = document.getElementById('delete-url-blog').value;
    ...
    var initToggleToolbar = () => {
        ...
        // Select elements
        toolbarBase = document.querySelector('[data-kt-blog-table-toolbar="base"]');
        toolbarSelected = document.querySelector('[data-kt-blog-table-toolbar="selected"]');
        selectedCount = document.querySelector('[data-kt-blog-table-select="selected_count"]');
        const deleteSelected = document.querySelector('[data-kt-blog-table-select="delete_selected"]');
