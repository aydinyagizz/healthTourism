...
var KTUserSocialMediaList = function () {
    // Define shared variables
    var table = document.getElementById('kt_table_social_media');
    var datatable;
    var toolbarBase;
    var toolbarSelected;
    var selectedCount;
    ...
    var handleSearchDatatable = () => {
        const filterSearch = document.querySelector('[data-kt-social-media-table-filter="search"]');
    ...
    var handleResetForm = () => {
        // Select reset button
        const resetButton = document.querySelector('[data-kt-social-media-table-filter="reset"]');

        // Reset datatable
        resetButton.addEventListener('click', function () {
            // Select filter options
            const filterForm = document.querySelector('[data-kt-social-media-table-filter="form"]');
            const selectOptions = filterForm.querySelectorAll('select');
    ...
    var handleDeleteRows = () => {
        ...
        const deleteButtons = table.querySelectorAll('[data-kt-social-media-table-filter="delete_row"]');
        ...
        deleteButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                const socialMediaId = parent.querySelectorAll('td')[1].querySelectorAll('a')[0].getAttribute('data-id');
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        Swal.fire({
                            ...
                            var deleteUrl = document.getElementById('delete-url-user-social-media').value;
    ...
    var initToggleToolbar = () => {
        ...
        // Select elements
        toolbarBase = document.querySelector('[data-kt-social-media-table-toolbar="base"]');
        toolbarSelected = document.querySelector('[data-kt-social-media-table-toolbar="selected"]');
        selectedCount = document.querySelector('[data-kt-social-media-table-select="selected_count"]');
        const deleteSelected = document.querySelector('[data-kt-social-media-table-select="delete_selected"]');
