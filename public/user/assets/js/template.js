...
var KTTemplate = function () {
    ...
    // const initDropzone = () => {
    //     var myDropzone = new Dropzone("#kt_user_template", {
    ...
    const handleDiscount = () => {
        const discountOptions = document.querySelectorAll('input[name="template"]');
        const template1 = document.getElementById('kt_user_template_1');
        const percentageEl = document.getElementById('kt_user_template_2');
        const fixedEl = document.getElementById('kt_user_template_3');
