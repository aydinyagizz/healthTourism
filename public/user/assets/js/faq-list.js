...
var KTUserFaqList = function () {
    ...
    var handleDeleteRows = () => {
        ...
        const deleteButtons = table.querySelectorAll('[data-kt-faq-table-filter="delete_row"]');
        ...
        deleteButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                const faqId = parent.querySelectorAll('td')[1].querySelectorAll('a')[0].getAttribute('data-id');
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        Swal.fire({
                            ...
                            var deleteUrl = document.getElementById('delete-url-user-faq').value;
    ...
    var initToggleToolbar = () => {
        ...
        // Select elements
        toolbarBase = document.querySelector('[data-kt-faq-table-toolbar="base"]');
