...
<head>
    ...
    <link href="{{ asset('public/user/assets/plugins/custom/datatables/datatables.bundle.css') }}" rel="stylesheet"
          type="text/css"/>
    <link href="{{ asset('public/user/assets/plugins/custom/vis-timeline/vis-timeline.bundle.css') }}" rel="stylesheet"
          type="text/css"/>
    <!--end::Vendor Stylesheets-->


    <!--begin::Global Stylesheets Bundle(mandatory for all pages)-->
    <link href="{{ asset('public/user/assets/plugins/global/plugins.bundle.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('public/user/assets/css/style.bundle.css') }}" rel="stylesheet" type="text/css"/>
    ...
    <div class="page d-flex flex-row flex-column-fluid">
        ...
        >
            ...
            <div class="aside-menu flex-column-fluid px-3 px-lg-6">
                ...
                <!--begin::Menu-->
                <div
                    class="menu menu-column menu-sub-indention menu-active-bg menu-pill menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-arrow-gray-500 fw-semibold fs-5 my-5 mt-lg-2 mb-lg-0"
                    id="kt_aside_menu"
                    data-kt-menu="true">
...
<path opacity="0.3"
      ...
      fill="currentColor"/>
                        ...
                        <a href="{{ route('user.index') }}" class="d-lg-none">
                            <img width="50px" alt="Logo"
                                 src="{{ asset('public/adminFrontend/assets/logo/HOLIDAYHEALTH.png') }}"
                                 class="max-h-40px"/>
                        </a>
                        <!--end::Logo-->
                    </div>
                    ...
                    <div class="d-flex align-items-center flex-shrink-0">
                        ...
                        {{--                                     src="{{ asset('public/admin/assets/media/svg/brand-logos/tower.svg') }}" alt=""/>--}}
                        {{--                            </span>--}}
                        {{--                                                    </div>--}}
                        {{--                                                    <!--end::Symbol-->--}}
                        ...
                        {{--<span class="svg-icon svg-icon-2 svg-icon-primary"><svg width="18" height="18" viewBox="0 0 18 18" fill="none"--}}
                        {{--                                                        xmlns="http://www.w3.org/2000/svg">--}}
                        {{--<path opacity="0.3"--}}
                        ...
                        {{--<rect x="13.6993" y="13.6656" width="4.42828" height="1.73089" rx="0.865447" transform="rotate(45 13.6993 13.6656)"--}}
                        {{--      fill="currentColor"/>--}}
                        {{--<path--}}
                        ...
                        {{--                                            <a href="indexa792.html?page=pages/search/horizontal"--}}
                        ...
                        <div class="d-flex align-items-center ms-2 ms-lg-3">
                            ...
                            {{--                            TODO: 'kt_activities_toggle' activity iconu --}}

                            {{--                            <div class="btn btn-icon btn-active-light-primary w-35px h-35px w-md-40px h-md-40px"--}}
                        ...
                        <!--begin::Chat-->
                        {{--       TODO: 'kt_drawer_chat_toggle' chat iconu --}}
                        ...
                        {{--                                                       class="d-flex flex-column flex-center text-center text-gray-800 text-hover-primary bg-hover-light rounded py-4 px-3 mb-3">--}}
                        {{--                                                        <img--}}
                        {{--                                                            src="{{ asset('public/admin/assets/media/svg/brand-logos/pinterest-p.svg') }}"--}}
                        {{--                                                            class="w-25px h-25px mb-2" alt=""/>--}}
                ...
                System
                        ...
                        <div class="d-flex align-items-center ms-2 ms-lg-3" id="kt_header_user_menu_toggle">
                            ...
                            <div
                                ...
                                {{--                                TODO: Diller language  açılır menüsü--}}
...
{{-- TODO: yandan açılan 'Activity Logs' modalı --}}
...
{{--                                    <!--begin::Title-->--}}
{{--                                    <a href="indexb27d.html?page=apps/projects/project"--}}
...
{{--                                    <div class="d-flex flex-aligns-center pe-10 pe-lg-20">--}}
{{--                                        <!--begin::Icon-->--}}
{{--                                        <img alt="/rider-html-pro/?page=apps/projects/project" class="w-30px me-3"--}}
...
{{--            <a href="indexa35e.html?page=pages/user-profile/activity" class="btn btn-bg-body text-primary">--}}
...
{{-- TODO: Yandan açılan chat modalı 'Brian Cox' --}}
...
{{--                    <!--begin::Section-->--}}
{{--                    <div class="mb-3">--}}
{{--                        <a href="index8e13.html?page=apps/ecommerce/sales/details"--}}
...
{{-- TODO: sayfanın sağ tarafında bulunan Explore sekmesinin açılır modalı 'Purchase Rider HTML Pro' --}}
...
{{--                    <!--begin::Purchase-->--}}
{{--                    <div class="mb-7">--}}
{{--                        <a href="https://keenthemes.com/products/rider-html-pro"--}}
...
<!--end::Exolore drawer-->
<!--begin::Help drawer-->
{{-- TODO: sayfanın sağ tarafında bulunan Help sekmesinin açılır modalı 'Learn & Get Inspired' --}}
...
{{--                <!--begin::Link-->--}}
{{--                <a href="https://preview.keenthemes.com/html/rider-html-pro/docs"--}}
...
{{--                <!--end::Link-->--}}
{{--                <!--begin::Link-->--}}
{{--                <a href="https://preview.keenthemes.com/html/rider-html-pro/docs//base/utilities"--}}
{{--                   class="parent-hover d-flex align-items-center mb-7">--}}
{{--                    <!--begin::Icon-->--}}
{{--                    <div--}}
...
{{--                <!--end::Link-->--}}
{{--                <!--begin::Link-->--}}
{{--                <a href="indexa048.html?page=layout-builder" class="parent-hover d-flex align-items-center mb-7">--}}
{{--                    <!--begin::Icon-->--}}
{{--                    <div--}}
...
{{--                <!--end::Link-->--}}
{{--                <!--begin::Link-->--}}
{{--                <a href="https://preview.keenthemes.com/html/rider-html-pro/docs/getting-started/changelog"--}}
{{--                   class="parent-hover d-flex align-items-center mb-7">--}}
{{--                    <!--begin::Icon-->--}}
{{--                    <div--}}
...
<style>
    .whatsapp-icon {
        position: fixed;
        bottom: 10px;
        right: 10px; /* Sağ alt köşe için right kullanın */
        z-index: 9999;
    }
</style>

<div class="engage-toolbar d-flex position-fixed px-5 fw-bold zindex-2 top-50 end-0  mt-5 mt-lg-20 gap-2">
    <div class="whatsapp-icon">
        <a href="https://wa.me/+9008503462314" target="_blank">
            <img style="max-width: 80px" src="{{ asset('public/user/assets/media/icons/WhatsApp.png') }}"
                 alt="WhatsApp">
        </a>
    </div>
</div>
...
<div class="engage-toolbar d-flex position-fixed px-5 fw-bold zindex-2 top-50 end-0 transform-90 mt-5 mt-lg-20 gap-2">
    ...
    {{--    TODO: Sayfanın sağ tarafında bulunan Explore Butonu --}}
    ...
    {{--    TODO: Sayfanın sağ tarafında bulunan Help Butonu --}}
    ...
    <!--begin::Purchase link-->
    {{--    TODO: Sayfanın sağ tarafında bulunan Buy Now Butonu --}}
                    ...
                    <div class="fv-row mb-8">
                        ...
                        <div class="" data-kt-modal-bidding-type="dollar">
                            ...
                            <select name="currency_dollar" aria-label="Select a Currency"
                                ...
                                <option
                                    data-kt-bidding-modal-option-icon="{{ asset('public/user/assets/media/flags/united-states.svg') }}"
                                    value="USD"
                                    selected><b>USD</b>&nbsp;-&nbsp;USA dollar
                                </option>
                                <option
                                    data-kt-bidding-modal-option-icon="{{ asset('public/user/assets/media/flags/united-kingdom.svg') }}"
                                    value="GBP">
                                    <b>GBP</b>&nbsp;-&nbsp;British pound
                                </option>
                                <option data-kt-bidding-modal-option-icon="flags/australia.svg" value="AUD"><b>AUD</b>&nbsp;-&nbsp;Australian
                                    dollar
                                </option>
                                <option data-kt-bidding-modal-option-icon="flags/japan.svg" value="JPY"><b>JPY</b>&nbsp;-&nbsp;Japanese
                                    yen
                                </option>
                                <option data-kt-bidding-modal-option-icon="flags/sweden.svg" value="SEK"><b>SEK</b>&nbsp;-&nbsp;Swedish
                                    krona
                                </option>
                                <option data-kt-bidding-modal-option-icon="flags/canada.svg" value="CAD"><b>CAD</b>&nbsp;-&nbsp;Canadian
                                    dollar
                                </option>
                                <option data-kt-bidding-modal-option-icon="flags/switzerland.svg" value="CHF"><b>CHF</b>&nbsp;-&nbsp;Swiss
                                    franc
                                </option>
                            </select>
                            <!--end::Select2-->
                        ...
                        <div class="d-none" data-kt-modal-bidding-type="crypto">
                            ...
                            <select name="currency_crypto" aria-label="Select a Coin"
                                    data-placeholder="Select a currency.."
                                    class="form-select form-select-solid form-select-lg">
                                <option data-kt-bidding-modal-option-icon="svg/coins/bitcoin.svg" value="1" selected>
                                    Bitcoin
                                </option>
                                ...
                                <option data-kt-bidding-modal-option-icon="svg/coins/ethereum.svg" value="5">Ethereum
                                </option>
                                <option data-kt-bidding-modal-option-icon="svg/coins/filecoin.svg" value="6">Filecoin
                                </option>
                        ...
                        <div class="d-flex flex-stack flex-grow-1 ">
                            ...
                            <div class=" fw-semibold">
                                ...
                                <div class="fs-6 text-gray-700 "> Not enough funds in your wallet? <a
                                        href="index898b.html?page=utilities/modals/wizards/top-up-wallet"
...
<rect x="7.41422" y="6" width="16" height="2" rx="1" transform="rotate(45 7.41422 6)" fill="currentColor"/>
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                ...
                <div class="btn btn-light-primary fw-bold w-100 mb-8">
                    <img alt="Logo" src="{{ asset('public/user/assets/media/svg/brand-logos/google-icon.svg') }}"
                         class="h-20px me-3"/>
...
<!-- Mirrored from preview.keenthemes.com/rider-html-pro/?page=index by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Feb 2023 10:02:22 GMT -->
</html>
