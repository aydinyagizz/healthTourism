...
<path
    ...
    fill="currentColor"/>
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-company-table-toolbar="base">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                ...
                                <!--begin::Content-->
                                <div class="px-7 py-5" data-kt-diseases-category-table-filter="form">
                                    <!--begin::Input group-->
                                    <div class="mb-10">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <button type="reset"
                                                ...
                                                data-kt-menu-dismiss="true" data-kt-diseases-category-table-filter="reset">
                                            Reset
                                        </button>
                    ...
                    <div class="card-body py-4  table-responsive">
                        ...
                        <!--begin::Table-->
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_diseases_category">
                            <!--begin::Table head-->
                            <thead>
                            <!--begin::Table row-->
                                ...
                                <th class="w-10px pe-2">
                                    <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                        <input class="form-check-input" type="checkbox" data-kt-check="true"
                                               data-kt-check-target="#kt_table_diseases_category .form-check-input"
                                               value=""/>
                                    </div>
                                </th>
...
<path
    ...
    fill="currentColor"/>
                                        ...
                                        <div
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="#" data-bs-toggle="modal"
                                                   data-bs-target="#diseasesCategoryEdit{{ $item->id }}"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="#" class="menu-link px-3"
                                                   data-kt-diseases-category-table-filter="delete_row">
                                                    Delete
                                                </a>
                                            </div>
                                            <!--end::Menu item-->
                                ...
                                <div class="modal fade" id="diseasesCategoryEdit{{ $item->id }}" tabindex="-1"
                                ...
                                <span class="svg-icon svg-icon-1">
                                    <svg width="24" height="24"
                                        ...
                                        <rect x="7.41422" y="6" width="16" height="2" rx="1"
                                            ...
                                            <form action="{{ route('admin.disease.category.update', [$item->id]) }}"
                                                  method="POST">
                                                @csrf
        ...
        <div class="modal fade " id="kt_modal_add_diseases_category" tabindex="-1"
             aria-hidden="true">
            <!--begin::Modal dialog-->
            <div class="modal-dialog modal-dialog-centered mw-650px">
                ...
                <div class="modal-content">
                    <!--begin::Form-->
                    <form class="form" method="POST" action="{{ route('admin.disease.category.add') }} "
                          id="kt_modal_add_diseases_category_form"
                          data-kt-redirect-diseases-category="">
                        @csrf
                        <!--begin::Modal header-->
...
<rect x="7.41422" y="6" width="16" height="2" rx="1" transform="rotate(45 7.41422 6)" fill="currentColor"/>
                        ...
                        <div class="modal-footer flex-center">
                            <!--begin::Button-->
                            <button type="reset" id="kt_modal_add_diseases_category_cancel"
        ...
        <input type="hidden" id="delete-url-diseases-category" value="{{ route('admin.disease.category.delete') }}">
