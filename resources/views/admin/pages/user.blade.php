                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-users-table-toolbar="base">
                            ...
                            <a type="button" class="btn btn-primary" data-bs-toggle="modal"
                               data-bs-target="#kt_modal_add_users_import">
                                Import Users
                            </a>
...
{{--                                                   data-bs-target="#userEdit{{ $item->id }}"--}}
        ...
        {{--                            TODO: Add users import modal start  --}}
        <div class="modal fade " id="kt_modal_add_users_import" tabindex="-1"
             aria-hidden="true">
            <!--begin::Modal dialog-->
            <div class="modal-dialog modal-dialog-centered mw-650px">
                ...
                <div class="modal-content">
                    <!--begin::Form-->
                    <form class="form" method="POST" action="{{ route('admin.user.import') }} "
                          id="kt_modal_add_users_import_form" enctype="multipart/form-data"
                        ...
                        <div class="modal-header" id="kt_modal_add_customer_header">
                            ...
                            <div id="kt_modal_add_users_close" data-bs-dismiss="modal"
...
<rect x="7.41422" y="6" width="16" height="2" rx="1" transform="rotate(45 7.41422 6)" fill="currentColor"/>
                        ...
                        <div class="modal-body py-10 px-lg-17">
                            ...
                            <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll"
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <label class="required fs-6 fw-semibold mb-2">Users File</label>
                                    <input type="file" class="form-control form-control-solid" accept=".xlx, .xls, .xlsx"
                                           placeholder="Users File" name="users_file" id="users_file"/>
                                </div>
        ...
        {{--                            TODO: Add users import modal end  --}}
