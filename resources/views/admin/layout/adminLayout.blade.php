...
{{--    <link rel="canonical" href="https://preview.keenthemes.com/rider-html-pro"/>--}}
    ...
    <link href="{{ asset('public/admin/assets/plugins/custom/datatables/datatables.bundle.css') }}" rel="stylesheet"
          type="text/css"/>
    <link href="{{ asset('public/admin/assets/plugins/custom/vis-timeline/vis-timeline.bundle.css') }}" rel="stylesheet"
          type="text/css"/>
                ...
                <div
                    ...
                    >
                        ...
                        <a href="{{ route('admin.index') }}">
                            <div
                                class="menu-item   {{ Route::is('admin.index') ? 'show' : '' }} menu-accordion mb-1">
                    ...
                    <div class="fv-row mb-8">
                        ...
                        <div class="" data-kt-modal-bidding-type="dollar">
                            ...
                            <select name="currency_dollar" aria-label="Select a Currency"
                                ...
                                <option
                                    data-kt-bidding-modal-option-icon="{{ asset('public/admin/assets/media/flags/united-states.svg') }}"
                                    value="USD"
                                    selected><b>USD</b>&nbsp;-&nbsp;USA dollar
                                </option>
                                <option
                                    data-kt-bidding-modal-option-icon="{{ asset('public/admin/assets/media/flags/united-kingdom.svg') }}"
                                    value="GBP">
...
<rect x="7.41422" y="6" width="16" height="2" rx="1" transform="rotate(45 7.41422 6)" fill="currentColor"/>
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                ...
                <div class="btn btn-light-primary fw-bold w-100 mb-8">
                    <img alt="Logo" src="{{ asset('public/admin/assets/media/svg/brand-logos/google-icon.svg') }}"
                         class="h-20px me-3"/>
