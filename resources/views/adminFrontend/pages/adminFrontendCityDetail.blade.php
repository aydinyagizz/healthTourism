                    ...
                    <div class="col-lg-8 posts-list">
                        <div class="single-post">
                            <div class="feature-img">
                                @if($city->image)
                                    <img class="img-fluid" src="data:image/jpeg;base64,{{ $city->image }}" alt="{{ $city->name }}">
                                @else
                                ...
                                <div class="row">
                                    ...
                                    <div
                                        ...
                                        <div class="thumb">
                                            <a href="{{ route('admin.frontend.city.detail',[$prevCity->slug]) }}">
                                                @if($prevCity->image)
                                                    <img style="max-width: 100px!important;" class="img-fluid" src="data:image/jpeg;base64,{{ $prevCity->image }}" alt="{{ $prevCity->name }}">
                                    ...
                                    <div
                                        ...
                                        <div class="thumb">
                                            <a href="{{ route('admin.frontend.city.detail',[$nextCity->slug]) }}">
                                                @if($nextCity->image)
                                                    <img style="max-width: 100px!important;" class="img-fluid" src="data:image/jpeg;base64,{{ $nextCity->image }}" alt="{{ $nextCity->name }}">
                        ...
                        <div class="blog_right_sidebar">
                            ...
                            <aside class="single_sidebar_widget post_category_widget">
                                ...
                                <ul class="list cat-list">
                                    ...
                                    <li>
                                        <a href="{{ route('admin.frontend.diseases.detail', [$item->slug]) }}" class="d-flex">
                                            <p>{{ $item->title }}</p>
                                        </a>
                                    </li>
                                    @endforeach
