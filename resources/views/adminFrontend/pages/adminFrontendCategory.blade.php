                ...
                <div class="row justify-content-between">
                    <div class="col-lg-3 col-md-6">
                        <div class="single-services text-center mb-50">
                            ...
                            <!-- Shpape -->
                            <img class="shape1 d-none d-lg-block" src="{{ asset('public/adminFrontend/assets/img/icon/serices1.pn') }}g" alt="">
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="single-services text-center mb-50">
                            ...
                            <img class="shape2 d-none d-lg-block" src="{{ asset('public/adminFrontend/assets/img/icon/serices2.png') }}" alt="">
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="single-services text-center mb-50">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-location mb-30">
                            <div class="location-img">
                                <img src="{{ asset('public/adminFrontend/assets/img/gallery/location1.png') }}" alt="">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-location mb-30">
                            <div class="location-img">
                                <img src="{{ asset('public/adminFrontend/assets/img/gallery/location2.png') }}" alt="">
                            </div>
                            <div class="location-details">
                                <p>Paris</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-location mb-30">
                            <div class="location-img">
                                <img src="{{ asset('public/adminFrontend/assets/img/gallery/location3.png') }}" alt="">
                            </div>
                            <div class="location-details">
                                <p>Rome</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-location mb-30">
                            <div class="location-img">
                                <img src="{{ asset('public/adminFrontend/assets/img/gallery/location4.png') }}" alt="">
                            </div>
                            <div class="location-details">
                                <p>Italy</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-location mb-30">
                            <div class="location-img">
                                <img src="{{ asset('public/adminFrontend/assets/img/gallery/location5.png') }}" alt="">
                            </div>
                            <div class="location-details">
                                <p>Nepal</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-location mb-30">
                            <div class="location-img">
                                <img src="{{ asset('public/adminFrontend/assets/img/gallery/location6.png') }}" alt="">
                            </div>
                            <div class="location-details">
                                <p>indonesia</p>
